  ...
  return (
    <>
      ...
      <section className="py-16 bg-gradient-to-b from-purple-50 to-white">
        <div className="container">
          <AnimatedSection className="text-center mb-12">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-100 to-teal-100 rounded-full text-sm font-medium mb-4">
      ...
      {products.map((product, index) => (
        <section 
          key={product.title} 
          className={`py-20 ${index % 2 === 0 ? 'bg-white' : 'bg-gradient-to-br from-slate-50 to-purple-50'}`}
        >
          <div className="container">
            <div className={`grid lg:grid-cols-2 gap-12 items-center ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
              <AnimatedSection direction={index % 2 === 0 ? 'left' : 'right'}>
                <div className="relative">
                  ...
                  <div className={`absolute -bottom-6 ${index % 2 === 0 ? '-right-6' : '-left-6'} bg-gradient-to-r ${product.color} text-white p-4 rounded-xl shadow-xl`}>
              ...
              <AnimatedSection direction={index % 2 === 0 ? 'right' : 'left'} delay={0.2}>
                <div className="space-y-6">
                  ...
                  <div className="grid sm:grid-cols-2 gap-3">
                    {product.features.map((feature) => (
                      <div key={feature} className="flex items-center gap-3">
                        <div className={`h-5 w-5 rounded-full bg-gradient-to-r ${product.color} flex items-center justify-center`}>
                  ...
                  <div className="flex flex-wrap gap-4 pt-4">
                    <Button size="lg" className={`bg-gradient-to-r ${product.color} hover:opacity-90`} asChild>
                      <Link href="/contact">
                        Request Demo
